...
class PatientFinder extends React.Component<PatientFinderProps, IPatientFinderOwnState> {
  ...
  selectPractitionerHandler() {
    ...
    let exist = R.findIndex(R.propEq('practitionerId', this.state.query))(this.props.patients);
      ...
      <Section>
        ...
        <Card>
          ...
          <SearchForm>
            ...
            <div>
              <Button 
                onClick={ () => this.selectPractitionerHandler() }>
                Buscar
              </Button>
            </div>
          </SearchForm>
...
type PatientFinderProps = IPatientFinderStateProps & IPatientFinderDispatchProps